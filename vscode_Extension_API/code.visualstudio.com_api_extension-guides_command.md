...
### [Controlling when a command shows up in the Command Palette](https://code.visualstudio.com/api/extension-guides/command\#controlling-when-a-command-shows-up-in-the-command-palette)
