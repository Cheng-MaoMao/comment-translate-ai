...
[Edit](https://vscode.dev/github/microsoft/vscode-docs/blob/main/api/extension-guides/file-icon-theme.md "Edit this document in vscode.dev")
...
## [Adding a new File Icon Theme](https://code.visualstudio.com/api/extension-guides/file-icon-theme\#adding-a-new-file-icon-theme)
...
### [File Icon Set File](https://code.visualstudio.com/api/extension-guides/file-icon-theme\#file-icon-set-file)
...
### [Icon definitions](https://code.visualstudio.com/api/extension-guides/file-icon-theme\#icon-definitions)
...
### [File association](https://code.visualstudio.com/api/extension-guides/file-icon-theme\#file-association)

Icons can be associated to folders, folder names, files, file extensions, file names and [language IDs](https://code.visualstudio.com/api/references/contribution-points#contributes.languages).
...
### [Font definitions](https://code.visualstudio.com/api/extension-guides/file-icon-theme\#font-definitions)
...
### [Folder icons in File Icon Themes](https://code.visualstudio.com/api/extension-guides/file-icon-theme\#folder-icons-in-file-icon-themes)
